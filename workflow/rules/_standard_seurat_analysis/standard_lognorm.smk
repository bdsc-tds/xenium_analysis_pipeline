...
use rule runStandardLogNorm as runPostCountCorrectionByOvrlpyStandardLogNorm with:
    ...
    output:
        obj=f'{config["output_path"]}/post_count_correction_std_seurat_analysis/{{segmentation_id4ovrlpy}}/{{sample_id}}/{{count_correction_id}}/signal_integrity_threshold={config["count_correction"]["ovrlpy"]["signal_integrity_threshold"]}/lognorm/normalised_counts/normalised_seurat.rds',
        cells=protected(f'{config["output_path"]}/post_count_correction_std_seurat_analysis/{{segmentation_id4ovrlpy}}/{{sample_id}}/{{count_correction_id}}/signal_integrity_threshold={config["count_correction"]["ovrlpy"]["signal_integrity_threshold"]}/lognorm/normalised_counts/cells.parquet'),
        data=protected(f'{config["output_path"]}/post_count_correction_std_seurat_analysis/{{segmentation_id4ovrlpy}}/{{sample_id}}/{{count_correction_id}}/signal_integrity_threshold={config["count_correction"]["ovrlpy"]["signal_integrity_threshold"]}/lognorm/normalised_counts/data.parquet'),
        scale_data=protected(f'{config["output_path"]}/post_count_correction_std_seurat_analysis/{{segmentation_id4ovrlpy}}/{{sample_id}}/{{count_correction_id}}/signal_integrity_threshold={config["count_correction"]["ovrlpy"]["signal_integrity_threshold"]}/lognorm/normalised_counts/scale_data.parquet')
    log:
        f'{config["output_path"]}/post_count_correction_std_seurat_analysis/{{segmentation_id4ovrlpy}}/{{sample_id}}/{{count_correction_id}}/signal_integrity_threshold={config["count_correction"]["ovrlpy"]["signal_integrity_threshold"]}/lognorm/logs/runPostCountCorrectionByOvrlpyStandardLogNorm.log'
    wildcard_constraints:
