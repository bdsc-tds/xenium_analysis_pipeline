                    ...
                    for reference in references:
                        for method in methods:
                            for color in colors:
                                ...
                                out_file = figures_dir / f"embed_panel_restricted_genes/{name}/umap_{layer}_{n_comps=}_{n_neighbors=}_{min_dist=}_{metric}_{reference}_{method}_{color}.{extension}"
                                out_files_panel.append(out_file)

                                rule:
                                    name: f'embed_panel_restricted_genes_plot/{name}/umap_{layer}_{reference}_{method}_{color}'
                                    input:
                                        panel=panel,
...
rule embed_panel_restricted_genes_plot_all:
    input:
        out_files_panel
