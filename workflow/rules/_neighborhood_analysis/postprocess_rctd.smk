...
rule runPostprocessRCTD:
    input:
        rctd_result=f'{config["output_path"]}/cell_type_annotation/{{segmentation_id}}/{{sample_id}}/{{normalisation_id}}/{{annotation_id}}/output.rds' # annotation_id - reference_name/class_aware_rctd/Leveli
    output:
